const POTICKTEXT = `Политика обработки персональныхданных
...
ты в
нты в социальных сетях, а также —
прочие, заполняемые поля
форм информация о типе используемого пользователем браузера,
      детали, просмотренные Пользователемстраниц,
      IP-адрес Пользователя, гиперссылки, по
которым переходил пользователь внутри сайта;

Пользуясьсервисами «ЗАКАЗАТЬ ЗВОНОК» «ПОДПИСАТЬСЯ НА КАНАЛ В ТЕЛЕГРАММ» «НАПИСАТЬ В
МЕССЕНДЖЕР» «ОФОРМЛЕНИЕ ЗАКАЗА» и подобными сервисами на сайте Оператора,Пользователь тем самым дает свое согласие на обработку его персональных данных,
указанных в Политике, путем проставления галочек в виджете при записи (блок«Согласие клиента»).
Также
на Сайте происходит сбор и обработка обезличенных данных о посетителях (в т.ч.файлов «cookie») посредством форм сбора персональных данных «ЗАКАЗАТЬ ЗВОНОК»
«ПОДПИСАТЬСЯ НА КАНАЛ В ТЕЛЕГРАММ» «НАПИСАТЬ В МЕССЕНДЖЕР» «ОФОРМЛЕНИЕ ЗАКАЗА»и подобных, а также посредством сервисов интернет статистики (Яндекс Метрика и
других).


4.Обработка специальных категорий персональных данных, касающихся расовой,
национальной принадлежности, политических взглядов, религиозных или философскихубеждений, интимной жизни, Оператором не осуществляется.
Обработка
персональных данных, разрешенных для распространения, из числа специальныхкатегорий персональных данных, указанных в ч. 1 ст. 10 Закона о персональных
данных, допускается, если соблюдаются запреты и условия, предусмотренные ст.10.1 Закона о персональных данных.
Пользователь
подтверждает свое согласие на предоставление части своих персональных данных(адрес, ФИО, телефон) третьим лицам для выполнения обозначенных целей Оператора
и выполнением Оператором обязательств перед Пользователем, например дляосуществления доставки.
Передача
(распространение, предоставление, доступ) персональных данных, разрешенныхсубъектом персональных данных для распространения, должна быть прекращена в
любое время по требованию субъекта персональных данных. Данное требованиедолжно включать в себя фамилию, имя, отчество (при наличии), контактную
информацию (номер телефона, адрес электронной почты или почтовый адрес)субъекта персональных данных, а также перечень персональных данных, обработка
которых подлежит прекращению. Указанные в данном требовании персональные данныемогут обрабатываться только Оператором, которому оно направлено.
Согласие
на обработку персональных данных, разрешенных для распространения, прекращаетсвое действие с момента поступления Оператору соответствующего требования
Пользователя в отношении обработки персональных данных.
5.Оператор и его работники несут гражданско-правовую, административную и иную
ответственность за несоблюдение принципов и условий обработки персональныхданных, а также за разглашение или незаконное использование персональных данных
в соответствии с законодательством Российской Федерации. Порядок доступасубъекта персональных данных к его персональным данным, обрабатываемым
Исполнителем, определяется в соответствии с законодательством РоссийскойФедерации и внутренними документами Оператора.
6.
Обработка персональных данных прекращается по достижении целей обработки,истечении срока обработки, предусмотренного федеральными законами, договором
или согласием субъекта персональных данных на обработку его персональныхданных. При отзыве субъектом персональных данных согласия на обработку его
персональных данных, обработка персональных данных осуществляется только дляисполнения ранее заключенных с ним договоров, а также в случаях,
предусмотренных законодательством Российской Федерации.




7.Субъекты персональных данных имеют право на:
-получение
полной информации об их персональных данных, обрабатываемых Оператором;
-уточнениесвоих персональных данных, их блокирование или уничтожение в случае, если
персональные данные являются неполными, устаревшими, неточными, незаконнополученными или не являются необходимыми для заявленной цели обработки;
-отзыв
согласия на обработку Оператором персональных данных;
-принятиепредусмотренных законодательством Российской Федерации мер по защите своих
прав;
8.При обработке персональных данных Оператор с учётом требований законодательства
Российской
Федерации в области персональных данных проводит необходимыеорганизационно-технические и правовые мероприятия для защиты персональных
данных от неправомерного или случайного доступа к ним, уничтожения, изменения,блокирования, копирования, предоставления, распространения персональных данных,
а также от иных неправомерных действий в отношении персональных данных,предусмотренных внутренними документами Оператора.
9.
Оператор имеет право направлять Пользователю уведомления о новых продуктах иуслугах, специальных предложениях и различных событиях. Пользователь всегда
может отказаться от получения информационных сообщений, направив Операторуписьмо на адрес электронной почты info@florimondi.ru с
пометкой «Отказ от уведомлений о новых продуктах и услугах и специальныхпредложениях», а также позвонив по телефону +7977-299-36-29 или написав в
мессенджер.
10.Политика не распространяется ни на какие другие сайты и не применима к
веб-сайтам третьих лиц, которые могут содержать упоминание о нашем сайте и скоторых могут делаться ссылки на сайт, а также ссылки с этого сайта на другие
сайты сети интернет. Мы не несем ответственности за действия других веб-сайтов.
11.Оператор имеет право по своему усмотрению обновлять данную политику
конфиденциальности в любое время. Мы рекомендуем пользователям регулярнопроверять эту страницу https://florimondi.ru/privacy-policy/
для того, чтобы быть в курсе любых изменений о том, как мы защищаем информациюо пользователях, которую мы собираем. Используя сайт, вы соглашаетесь с
принятием на себя ответственности за периодическое ознакомление с политикойконфиденциальности и изменениями в ней.
12.
Настоящим, Пользователь подтверждает, что:
·       ознакомлен и согласен с тем, что передача
персональных данных Пользователя может осуществляться Оператором в объеме,необходимом для получения Пользователем доступа к Сайту, его содержанию и/или
его сервису/сервисам путем заполнения соответствующих текстовых полей и/или прикрепленныхк формам файлов;
·
выражает полное, безоговорочное иоднозначное согласие на обработку своих персональных данных Оператором для
целей Оператора
·       проинформирован о возможности отзыва
согласия на основании положений Федерального закона от 27.07.2006 № 152-ФЗ «Оперсональных данных» путем личного обращения или направления письменного
обращения (в том числе в форме электронного документа, подписанного простойэлектронной подписью или усиленной квалифицированной электронной подписью), на
имя Оператора, в том числе проинформирован о праве отозвать Согласие в целяхпрекращения обработки Оператором;
·
проинформирован, что Оператор вправепродолжать обработку персональных данных Пользователя после получения отзыва
Согласия, а равно после истечения срока действия Согласия, при наличииоснований, предусмотренных частью 2 статьи 9 Федерального закона от 27.07.2006
...
Действуя свободно,своей волей и в своем интересе, а также подтверждая свою дееспособность, даю
свое согласие Индивидуальному предпринимателю Карпунину Андрею Анатольевичу  ИНН: 771971874638 ОГРНИП: 320774600392892  (далее – Оператор), на обработку своихперсональных данных со следующими условиями:

1.Предоставление
информации Пользователем:

1.1. ДанноеСогласие дается на обработку персональных данных, как без использования средств
автоматизации, так и с их использованием. Согласие дается на обработкуследующих моих персональных данных: имя, фамилия, отчество, номера телефонов,
адреса электронной почты, адреса для доставки товаров или оказания услуг,реквизиты компании, которую представляет пользователь, должность в компании,
которую представляет пользователь, аккаунты в социальных сетях либо другуюинформацию которую Пользователь считает необходимым сообщить; при заполнении
форм: «ЗАКАЗАТЬ ЗВОНОК» «ПОДПИСАТЬСЯ НА КАНАЛ В ТЕЛЕГРАММ» «НАПИСАТЬ ВМЕССЕНДЖЕР» «ОФОРМЛЕНИЕ ЗАКАЗА и иным средствам коммуникации, размещенных по
адресу florimondi.ru и чатботу расположенному на интернет ресурсе Telegram Messenger
nger по адресу @Flori_Mondi_Bot
(далее – Сайт и чат бот) Состав информации может отличаться в зависимости откатегории пользователя и предоставленной Пользователем информации.

1.2. Пользователь
дает свое согласие Оператору на обработку информации, предоставляемуюПользователем в процессе деятельности Оператора

1.3. Целью
обработки персональных данных является:
·       предоставления доступа Пользователю к
сервисам, информации и/или материалам, содержащимся на Сайте.
·       продажи товаров и услуг, исполнения
договоров купли-продажи, аутентификацию и подтверждение действий пользователя,индивидуальный учёт клиентских заказов, обработку и доставку заказов, для повышение
качества работы и оказываемых услуг, информирование о специальных предложенияхи акциях
·
защиты жизни, здоровья и иных жизненноважных интересов субъектов персональных данных;
·
в иных законных целях.

1.4. В ходеобработки с персональными данными будут совершены следующие действия: сбор;
запись; систематизация; накопление; хранение; уточнение (обновление,изменение); извлечение; использование; блокирование; удаление; уничтожение.

1.5.
Предоставляя свои персональные данные, Пользователь соглашается на их обработкуОператором, в целях исполнения Оператором своих обязательств перед
Пользователем. Пользователь подтверждает свое согласие напредоставление части своих персональных данных (адрес, ФИО, телефон) третьим
лицам для выполнения обозначенных целей Оператора и только для исполнения
Оператором обязательств перед Пользователем: например для осуществлениядоставки.

1.6. Персональные
данные обрабатываются до достижения цели обработки либо до отзыва согласия наобработку персональных данных, в зависимости от того, какое из событий наступит
раньше.

1.7. При обработкеперсональных данных Пользователя, Оператор руководствуется Федеральным законом
«О персональных данных» и локальными нормативными документами Организации.

1.8. В случаевозникновения необходимости у Пользователя на любое действие, предусмотренное
Федеральным законом от 27.07.2006 № 152-ФЗ «О персональных данных» в частиобработки персональных данных Пользователь направляет официальный запрос
Оператору в порядке, предусмотренном Политикой Оператора в отношении обработкиперсональных данных пользователей сайта, размещенной по адресу https://www..ru/politika-obrabotki-personalnyh-dannyh.

1.9. В случае
выявления неточностей в персональных данных, Пользователь может актуализироватьих самостоятельно, направив Оператору уведомление на адрес электронной почты
Оператора info@florimondi.ru спометкой «Актуализация персональных данных».

1.10. Срок обработки
персональных данных определяется достижением целей, для которых были собраныперсональные данные, если иной срок не предусмотрен договором или действующим
законодательством.

Пользователь можетв любой момент отозвать свое согласие на обработку персональных данных,
направив Оператору уведомление посредством электронной почты на электронныйадрес Оператора info@florimondi.ru с
пометкой «Отзыв согласия на обработку персональных данных».

1.11. Операторвправе использовать технологию «cookies». Cookies – это небольшой фрагмент
данных, который сайт Оператора запрашивает у браузера, используемого накомпьютере или мобильном устройстве Пользователя. Cookies отражают предпочтения
Посетителя или его действия на Сайте, а также сведения об его оборудовании,дате и времени сессии. Сookies хранятся локально на компьютере или мобильном
устройстве Пользователя. Пользователь может удалить сохраненные Сookies в настройкахсоответствующего браузера.
Cookies не
содержат конфиденциальную информацию и не передаются третьим лицам. При первомпосещении сайта Оператора с помощью нового браузера или в режиме приватного просмотра
сайта предоставляется баннер, предупреждающий Пользователя об осуществлениисбора Сookies и запрашивающий согласие Посетителя на обработку его Сookies.
Нажимая кнопку «Согласен»
или продолжая пользоваться сайтом Пользователь предоставляет свое согласие наобработку его Сookies, а также подтверждает согласие с положениями Политики.
Продолжение
пользоваться Ссйтом означает осуществление Пользователем переходапо любой ссылке, размещенной на сайте, или нажатие любой кнопки на Сайте, а
также просмотр контента на любой странице Сайта
Пользователь можетотказаться от использования Сookies в настройках своего браузера (ознакомиться
с данной возможностью можно в разделе «Справка» соответствующего браузера). Втаком случае сайт будет использовать только те Cookies, которые строго
необходимы для его функционирования и предлагаемых им сервисов, однако такойотказ может привести к некорректной работе сайта

1.12. Этот сайт
использует сервис веб-аналитики Яндекс Метрика, предоставляемый компанией ООО«ЯНДЕКС», 119021, Россия, Москва, ул. Л. Толстого, 16 (далее — Яндекс)
Сервис Яндекс
Метрика использует технологию «cookie».
Собранная припомощи cookie информация не может идентифицировать вас, однако может помочь нам
улучшить работу нашего сайта. Информация об использовании вами данного сайта,будет передаваться и храниться на сервере Яндекса в Российской Федерации.
Яндекс будет обрабатывать эту информацию с целью анализа пользовательскойактивности
Вы можете
отказаться от использования cookies, выбрав соответствующие настройки вбраузере.
Используя этот
сайт, вы соглашаетесь на обработку данных о вас Яндексом в порядке и целях,указанных в Политике Оператора
Перечень данных, которые собирает счетчик Яндекс Метрики представлен по ссылке:
https://yandex.ru/support/metrica/code/data-collected.html

1.13. Оператор ненесет ответственности за сведения, предоставленные Пользователем на сайте в
общедоступной форме.

1.14. Оператор приобработке персональных данных принимает необходимые и достаточные
организационные и технические меры для защиты персональных данных отнеправомерного доступа к ним.`
