...
`;
    ...
    const isFirst = await collectionCategory.findOne({ 'categoryInfo.name': text });
    console.log('isfirt', isFirst);

    if (isFirst !== null ||isFirst !== undefined &&undefined && user.processType === 'catalog')) {
      await collectionUser.updateOne(
        { userId },
...
const slidesFor4k = [
  {
    ...
    caption: '✨ Яркий букет на день рождения из 9 кустовых пионовидных роз.\n💰 Цена:3 590 ₽',
  },
  ...
  },
  {
    ...
    caption: '💜 Букет на день рождения из 17 кружевных диантусов с эвкалиптом.\n💰 Цена: 4 590 ₽',
  },
  {
    photo:
      'https://florimondi.ru/upload/resize_cache/webp/iblock/4bf/u4p200na4f5frr9dm7iru00ffwyfb5nk.webp',
    caption: '🌷 Большой букет из 35 кустовых пионовидных роз Мисти Баблз.\n💰 Цена: 9 990 ₽',
  },
];
...
const slidesFor7k = [
  ...
  {
    photo: 'https://florimondi.ru/upload/iblock/149/ytt3g4qbus3u5vdqvr5gjorgkxzlq06d.jpg',
